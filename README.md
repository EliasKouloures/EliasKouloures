...
- [Agentic-Knowledge-Vault](https://github.com/EliasKouloures/agentic-knowledge-vault): local-first, model-agnostic, infinitely scalable knowledge system for any LLM (MIT)
